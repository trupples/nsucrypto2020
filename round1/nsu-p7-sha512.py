...
This variant uses sha512 instead of a random 20 bit perutation to prove the
algorithm works even for larger functions.
...
for i in range(1, 10):
	print(i, H([((1<<512) -1)*(~i%2)] * i))

h0 = H([123])
x = 133769420
fx = f(x)
print(H([123, x^h0, fx^h0]))
print(H([123]))
