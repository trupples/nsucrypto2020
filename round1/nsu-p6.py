...
NSU Crypto 2020 first round, problem 6 "CPA game"
...
def victor(alice):
	z1z2 = alice.random_valid_plaintext()
	next_iv = alice.query(z1z2, z1z2)
	enc0 = alice.query(next_iv, next_iv)

	while True:
		z = alice.random_valid_plaintext()
		if z != enc0:
			break

	r = alice.query(enc0, z)
